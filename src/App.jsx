...
import './App.css'
import SplashScreeam from './Componentes/SplashScreen'
...
function App() {
  ...
  useEffect(()=>{
    ...
    function success(pos) {
      ...
      axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${crd.latitude}&lon=${crd.longitude}&appid=06c2641d603433fdeebee5f57ac9bb0a
      `)
